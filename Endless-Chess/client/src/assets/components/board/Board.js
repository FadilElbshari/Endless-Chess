...
const Board = ({ allow, type, size, fen, flip = false, color, gameId, getTurn, getLegalMoves, makeMove, undoMove, getFen, checkGameOver }) => {
    ...
    // @ts-ignore
    const animateMove = (moveType, fromSquare, toSquare, enPassantFlagCheck, shortCastleFlag, longCastleFlag, enPassantSquare, turn, isUndo = 0, piece = null, enPassantPiece = null) => {
